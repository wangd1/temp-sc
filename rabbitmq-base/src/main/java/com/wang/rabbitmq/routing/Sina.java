...
public class Sina {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //绑定交换机和队列
        channel.queueBind(RabbitMQConstant.QUEUE_SINA,RabbitMQConstant.EXCHANGE_WEATHER_ROUTING,"22");
        channel.queueBind(RabbitMQConstant.QUEUE_SINA,RabbitMQConstant.EXCHANGE_WEATHER_ROUTING,"23");
