...
public class Baidu {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //绑定交换机和队列
        channel.queueBind(RabbitMQConstant.QUEUE_BAIDU,RabbitMQConstant.EXCHANGE_WEATHER_ROUTING,"12");
        channel.queueBind(RabbitMQConstant.QUEUE_BAIDU,RabbitMQConstant.EXCHANGE_WEATHER_ROUTING,"14");
